...
import
  necsus/runtime/
    [entityId, query, systemVar, inbox, directives, necsusConf, spawn, pragmas, tuples]
...
proc buildApp(
    runner: NimNode, systems: NimNode, conf: NimNode, pragmaProc: NimNode
): NimNode =
