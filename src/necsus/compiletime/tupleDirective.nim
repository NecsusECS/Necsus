...
type TupleDirective* = ref object ## A directive that contains a single tuple
...
proc hash*(directive: TupleDirective): Hash =
  hash(directive.args)
  ...
  if dir.filter == nil:
    ...
    for arg in dir.args:
      ...
      of DirectiveArgKind.Include:
        required.incl(arg.component.uniqueId)
      of DirectiveArgKind.Exclude:
        excluded.incl(arg.component.uniqueId)
