...
type
  ...
  WorldField* = tuple[name: string, typ: NimNode] ## A field to add to the world object
  ...
  HookGenerator*[T] =
    proc(details: GenerateContext, arg: SystemArg, name: string, dir: T): NimNode
  ...
  DirectiveGen* = ref object ## An object that can contribute to Necsus code generation
    ident*: string
    cachedHash: Hash
    ...
    of DirectiveKind.Mono:
      ...
      systemReturn*:
        proc(args: DirectiveSet[SystemArg], returns: MonoDirective): Option[NimNode]
...
proc defaultName(
    context, argName: NimNode, dir: MonoDirective | TupleDirective | DualDirective
): string =
  dir.name

proc defaultWorldField(
    name: string, dir: MonoDirective | TupleDirective | DualDirective
): seq[WorldField] =
  @[]

proc defaultSystemArg(
    name: string, dir: MonoDirective | TupleDirective | DualDirective
): NimNode =
  newDotExpr(appStateIdent, name.ident)

proc defaultNestedArgs(
    dir: MonoDirective | TupleDirective | DualDirective
): seq[RawNestedArg] =
  @[]
...
proc newGenerator*(
    ...
    worldFields: proc(name: string, dir: TupleDirective): seq[WorldField] =
      defaultWorldField,
...
proc newGenerator*(
    ...
    systemReturn:
      proc(args: DirectiveSet[SystemArg], returns: MonoDirective): Option[NimNode] =
      defaultSystemReturn,
    worldFields: proc(name: string, dir: MonoDirective): seq[WorldField] =
      defaultWorldField,
...
proc newGenerator*(
    ...
    worldFields: proc(name: string, dir: DualDirective): seq[WorldField] =
      defaultWorldField,
...
proc hash*(gen: DirectiveGen): Hash =
  gen.cachedHash
...
proc buildArchetype*(
  ...
  case arg.kind
  of DirectiveKind.Tuple:
    arg.generator.archetypeTuple(builder, systemArgs, arg.tupleDir)
  of DirectiveKind.Mono:
    arg.generator.archetypeMono(builder, systemArgs, arg.monoDir)
  of DirectiveKind.Dual:
    arg.generator.archetypeDual(builder, systemArgs, arg.dualDir)
  of DirectiveKind.None:
    discard
...
proc generateForHook*(arg: SystemArg, details: GenerateContext, name: string): NimNode =
  ...
  case arg.kind
  of DirectiveKind.Tuple:
    arg.generator.generateTuple(details, arg, name, arg.tupleDir)
  of DirectiveKind.Mono:
    arg.generator.generateMono(details, arg, name, arg.monoDir)
  of DirectiveKind.Dual:
    arg.generator.generateDual(details, arg, name, arg.dualDir)
  of DirectiveKind.None:
    arg.generator.generateNone(details, arg, name)

proc worldFields*(arg: SystemArg, name: string): seq[WorldField] =
  ## Generates the code for a specific hook
  case arg.kind
  of DirectiveKind.Tuple:
    arg.generator.worldFieldsTuple(name, arg.tupleDir)
  of DirectiveKind.Mono:
    arg.generator.worldFieldsMono(name, arg.monoDir)
  of DirectiveKind.Dual:
    arg.generator.worldFieldsDual(name, arg.dualDir)
  of DirectiveKind.None:
...
proc systemArg(arg: SystemArg, name: string): NimNode =
  ...
  case arg.kind
  of DirectiveKind.Tuple:
    arg.generator.systemArgTuple(name, arg.tupleDir)
  of DirectiveKind.Mono:
    arg.generator.systemArgMono(name, arg.monoDir)
  of DirectiveKind.Dual:
    arg.generator.systemArgDual(name, arg.dualDir)
  of DirectiveKind.None:
    arg.generator.systemArgNone(name)
...
proc systemArg*(
    directives: Table[DirectiveGen, DirectiveSet[SystemArg]], arg: SystemArg
): NimNode =
...
proc archetypeFor*(
    ctx: GenerateContext, components: openArray[ComponentDef]
...
iterator nodes*(arg: SystemArg): NimNode =
  ...
  case arg.kind
  of DirectiveKind.Tuple:
    for component in arg.tupleDir:
      yield component.node
  of DirectiveKind.Dual:
    for component in arg.dualDir:
      yield component.node
  of DirectiveKind.Mono:
