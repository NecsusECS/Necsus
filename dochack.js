...
function toToc_553648539(x_553648540, father_553648541) {
    ...
    Label12: {
      ...
      colontmp__553649340 = x_553648540.childNodes.length;
      var i_553649341 = 0;
      Label13: {
          Label14: while (true) {
    ...
    father_553648541.kids.push(e_553648609);;
      ...
      Label19: {
        ...
        colontmp__553649348 = x_553648540.childNodes.length;
        var i_553649349 = 0;
        Label20: {
            Label21: while (true) {
...
function uncovered_553648728(x_553648729) {
  ...
  BeforeRet: {
    ...
    Label2: {
      ...
      var i_553649377 = 0;
      var L_553649378 = (x_553648729.kids).length;
      Label3: {
          Label4: while (true) {
          if (!(i_553649377 < L_553649378)) break Label4;
            k_553648745 = x_553648729.kids[chckIndx(i_553649377, 0, (x_553648729.kids).length - 1)];
            ...
            i_553649377 += 1;
            if (!(((x_553648729.kids).length == L_553649378))) {
            failedAssertImpl_268435541(makeNimstrLit("iterators.nim(254, 11) `len(a) == L` the length of the seq changed while iterating over it"));
            }
  ...
  var result_553648761 = null;
    ...
    result_553648761 = news_553648760;
      ...
      Label1: {
        ...
        colontmp__553649373 = (news_553648760.kids).length;
        var i_553649374 = 0;
        Label2: {
            Label3: while (true) {
...
function buildToc_553648778(orig_553648779, types_553648780, procs_553648781) {
  var result_553648782 = null;
    ...
    Label1: {
      ...
      var i_553649365 = 0;
      var L_553649366 = (types_553648780).length;
      Label2: {
          Label3: while (true) {
          if (!(i_553649365 < L_553649366)) break Label3;
            t_553648791 = types_553648780[chckIndx(i_553649365, 0, (types_553648780).length - 1)];
            ...
            Label4: {
              ...
              var i_553649362 = 0;
              var L_553649363 = (procs_553648781).length;
              Label5: {
                  Label6: while (true) {
                  if (!(i_553649362 < L_553649363)) break Label6;
                    p_553648800 = procs_553648781[chckIndx(i_553649362, 0, (procs_553648781).length - 1)];
                    ...
                    i_553649362 += 1;
                    if (!(((procs_553648781).length == L_553649363))) {
                    failedAssertImpl_268435541(makeNimstrLit("iterators.nim(254, 11) `len(a) == L` the length of the seq changed while iterating over it"));
                    }
            ...
            i_553649365 += 1;
            if (!(((types_553648780).length == L_553649366))) {
            failedAssertImpl_268435541(makeNimstrLit("iterators.nim(254, 11) `len(a) == L` the length of the seq changed while iterating over it"));
            }
...
function HEX2EHEX2E_956301417(a_956301420, b_956301421) {
  var result_956301424 = ({a: 0, b: 0});

    result_956301424 = nimCopy(result_956301424, {a: a_956301420, b: b_956301421}, NTI956301397);
...
async function loadIndex_553649056() {
  ...
  BeforeRet: {
    ...
    var rootURL_553649090 = HEX5BHEX5D_721421595(cstrToNimstr(indexURL_553649064), HEX2EHEX2E_956301417(0, 14));
...
function escapeCString_553648879(x_553648880, x_553648880_Idx) {
    ...
    Label1: {
      ...
      var nHEX60gensym13_553649409 = ((x_553648880[x_553648880_Idx]) == null ? 0 : (x_553648880[x_553648880_Idx]).length);
      Label2: {
          Label3: while (true) {
          if (!(iHEX60gensym13_553649408 < nHEX60gensym13_553649409)) break Label3;
            c_553648882 = x_553648880[x_553648880_Idx].charCodeAt(chckIndx(iHEX60gensym13_553649408, 0, (x_553648880[x_553648880_Idx]).length - 1));
            switch (c_553648882) {
            case 60:
...
function HEX3Aanonymous_553648911(a_553648916, b_553648917) {
      var result_553648924 = 0;
        ...
        result_553648924 = subInt(b_553648917["Field1"], a_553648916["Field1"]);
    ...
    Label5: {
      ...
      Label6: {
          ...
          if (!(i_553649400 < colontmp__553649399)) break Label7;
            ...
            escapeCString_553648879(matches_553648894[chckIndx(i_553648941, 0, (matches_553648894).length - 1)]["Field0"], "innerHTML");
            add_553648276(ul_553648889, tree_553648258("LI", [matches_553648894[chckIndx(i_553648941, 0, (matches_553648894).length - 1)]["Field0"]]));
...
function wrapper_553649219() {
        ...
        var results_553649225 = dosearch_553648883(value_553649221);
