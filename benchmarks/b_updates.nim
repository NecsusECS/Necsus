...
proc movement(
    dt: TimeDelta, entities: Query[tuple[pos: ptr Position, dir: Direction]]
) =
...
proc runner(tick: proc(): void) =
  tick()
  benchmarkLoop "Updating " & $entityCount &
    " components: https://github.com/abeimler/ecs_benchmark", entityCount, 20:
    tick()
...
proc myApp() {.
  necsus(
    ...
    newNecsusConf(entityCount * 2, entityCount * 2, eagerAlloc = true),
  )
.}
